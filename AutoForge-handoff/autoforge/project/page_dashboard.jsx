/* ============================================================
   AutoForge — Dashboard (home / production overview)
   ============================================================ */

function Dashboard() {
  const d = AF.DASH;
  const sevColor = { critical: 'red', high: 'amber', medium: 'blue', low: 'green', Bug: 'red', Feature: 'ember', Improvement: 'blue', Debt: 'violet' };
  return (
              ...
              <div className="q-row" key={i}>
                ...
                <div className="q-main">
                  ...
                  <div className="q-meta">
                    ...
                    <span className={'chip ' + (sevColor[q.cat] || 'blue')} style={{ padding: '1px 7px', fontSize: 10 }}>{q.cat}</span>
                    <span>· {q.proj}</span>
                  </div>
                </div>
            ...
            {d.projects.map((p, i) => (
              <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 13, padding: '15px 18px', background: 'var(--bg-2)' }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{ fontSize: 12, color: 'var(--text-3)', marginTop: 2 }}>{p.desc} · <span style={{ fontFamily: 'var(--font-mono)' }}>{p.lang}</span></div>
                </div>
