...
font-note: >
  渲染环境离线确定性：Archivo Black 为渲染器预捆绑（仅 400 一档——其 400 即超粗展示
  字面，display 槽位直接用 weight 400 即可，不要合成加粗）；Noto Sans SC 本机已装
  （构建时自动捕获，CJK 用 400/700/800）；JetBrains Mono 预捆绑。禁网络 @import。

typography:
  # — reading ramp —
  body:    { fontFamily: "'Noto Sans SC', 'Inter', sans-serif", cqw: 1.2, weight: 400, lineHeight: 1.6 }
  lead:    { fontFamily: "'Noto Sans SC', 'Inter', sans-serif", cqw: 1.6, weight: 400, lineHeight: 1.5 }
  caption: { fontFamily: "'Archivo Black', 'Noto Sans SC', sans-serif", cqw: 0.9, weight: 400, lineHeight: 1.5 }
  label:   { fontFamily: "'JetBrains Mono', monospace", cqw: 0.72, weight: 500, tracking: "0.14em", upper: true }
  # — display / hero ramp (Archivo, lowercase, negative tracking) —
  h3:      { fontFamily: "'Archivo Black', 'Noto Sans SC', sans-serif", cqw: 2.8, weight: 700, lineHeight: 1.2, lower: true }
  quote-text:{ fontFamily: "'Archivo Black', 'Noto Sans SC', sans-serif", cqw: 3.8, weight: 700, lineHeight: 1.15, tracking: "-0.02em", lower: true }
  h2:      { fontFamily: "'Archivo Black', 'Noto Sans SC', sans-serif", cqw: 4.5, weight: 700, lineHeight: 1.1, tracking: "-0.02em", lower: true }
  stat-value:{ fontFamily: "'Archivo Black', 'Noto Sans SC', sans-serif", cqw: 5.5, weight: 800, lineHeight: 1.0, tracking: "-0.04em" }
  h1:      { fontFamily: "'Archivo Black', 'Noto Sans SC', sans-serif", cqw: 7.5, weight: 800, lineHeight: 0.9, tracking: "-0.03em", lower: true }
  fadelist-item:{ fontFamily: "'Archivo Black', 'Noto Sans SC', sans-serif", cqw: 7.5, weight: 800, lineHeight: 1.0, tracking: "-0.03em", lower: true }
  quote-mark:{ fontFamily: "'Archivo Black', 'Noto Sans SC', sans-serif", cqw: 10.0, weight: 800, lineHeight: 0.6 }
  fadelist-title:{ fontFamily: "'Archivo Black', 'Noto Sans SC', sans-serif", cqw: 10.5, weight: 800, lineHeight: 0.9, tracking: "-0.04em", lower: true }
  display: { fontFamily: "'Archivo Black', 'Noto Sans SC', sans-serif", cqw: 13.0, weight: 800, lineHeight: 0.88, tracking: "-0.04em", lower: true }
...
- **Fonts** — already set to **Archivo** (display) / **Noto Sans SC** (body); ignore any preset font name lingering in prose.
