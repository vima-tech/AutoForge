...
export const CONVERSATIONS: Conversation[] = [
  { id: 'g-vocant', type: 'group', name: 'Vocant · 助手页改版', initial: 'V', color: '#e8772e', members: ['analyst', 'coder', 'tester', 'architect'], unread: 2, time: '14:32', preview: '需求分析师：已生成需求 #CR-042 的分析报告…' },
  { id: 'd-analyst', type: 'direct', agent: 'analyst', unread: 0, time: '13:07', preview: '这个反馈与 #CR-031 重复度 82%，建议合并处理。' },
  { id: 'd-coder', type: 'direct', agent: 'coder', unread: 1, time: '11:45', preview: 'worktree autoforge/cr-042 已创建，预览构建中…' },
  { id: 'g-security', type: 'group', name: '安全加固讨论组', initial: '安', color: '#db5a40', members: ['security', 'architect', 'coder'], unread: 0, time: '昨天', preview: '安全审计：Layer 1 输入消毒需在 M4 前落地。' },
  { id: 'd-tester', type: 'direct', agent: 'tester', unread: 0, time: '昨天', preview: '主动巡检完成，发现 1 个 High、3 个 Medium 级问题。' },
  { id: 'd-architect', type: 'direct', agent: 'architect', unread: 0, time: '周一', preview: '建议预览路由初期用 Nginx reload，瓶颈后再评估 Traefik。' },
];
